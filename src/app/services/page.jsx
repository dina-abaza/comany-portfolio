...
export default function ServicesPage() {
  ...
  const items = [
    { id: 1, category: "mobile", title: "MOBILE APP DESIGN", description: "Modern and intuitive app interfaces." ,image:"/service5.png"},
    { id: 2, category: "website", title: "BUSINESS WEBSITES", description: "Professional corporate sites for companies.",image:"/service2.png" },
    { id: 3, category: "mobile", title: "CROSS-PLATFORM APPS", description: "Flutter or React Native apps for iOS & Android.",image:"/service22.jpg" },
    ...
    { id: 12, category: "website", title: "BLOG SYSTEM", description: "Create and manage blog content easily." ,image:"/service1.png",image:"/service23.jpg"},
    ...
    { id: 19, category: "maintenance", title: "DATA BACKUP", description: "Automatic secure data backups for your systems." ,image:"/service19.jpg"},
    { id: 20, category: "website", title: "MULTI-LANGUAGE WEBSITES", description: "Reach global audiences with multilingual support.",image:"/service20.jpg" },
  ];
