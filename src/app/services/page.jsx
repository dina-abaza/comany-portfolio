...
export default function ServicesPage() {
  ...
  const items = [
    ...
    { id: 3, category: "mobile", title: "CROSS-PLATFORM APPS", description: "Flutter or React Native apps for iOS & Android.",image:"/service18.png" },
  ...
  <div className="mt-8 md:mt-12 mb-12 ml-0 flex flex-col items-center gap-4 md:flex-row md:justify-start md:items-center md:ml-10">
